...
class StudentRepository(BaseRepository[Student]):
    ...
    def _create_dummy_instance(self) -> Student:
        return Student(
            id=0, name='', age=0, guardian_contact='', guardian_name=''
        )

    def filter(
        self, name: str = None, age: int = None, guardian_name: str = None
    ) -> list[Student]:
        ...
        for student in students:
            ...
            if (
                guardian_name
                and guardian_name.lower() not in student.guardian_name.lower()
            ):
                continue
